...
{
    public class BuscarAccionesCorrectivasHandler: IRequestHandler<BuscarIdAccionesCorrectivasQuery, List<AccionesResponse>>
    {
        ...
        public Task<List<AccionesResponse>> Handle(BuscarIdAccionesCorrectivasQuery request, CancellationToken cancellationToken)
        {
            try
            {
        ...
        private async Task<List<AccionesResponse>> HandleAsync(BuscarIdAccionesCorrectivasQuery request)
        {
            try
            {
