...
{
    public class AgregarIndicadorOrigenHandler : IRequestHandler<AgregarIndicadorOrigenCommand, IdIndicadoresResponse>
    {
        private readonly ApiDbContext _dbContext;
        private readonly ILogger<AgregarIndicadorOrigenHandler> _logger;
        public AgregarIndicadorOrigenHandler(ApiDbContext dbContext, ILogger<AgregarIndicadorOrigenHandler> logger)
        {
        ...
        public Task<IdIndicadoresResponse> Handle(AgregarIndicadorOrigenCommand request, CancellationToken cancellationToken)
        {
            try
            {
        ...
        private async Task<IdIndicadoresResponse> HandleAsync(AgregarIndicadorOrigenCommand request)
        {
            ...
            try
            {
                ...
                ///     Agrego el cierre
                ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                var response = IndicadoresMapper.MapRequestIndicadorOrigenEntity(request._request);
                _dbContext.IndicadorOrigen.Add(response);
